...
export default function Collaborate() {
  ...
  return (
    <section className="relative py-20 px-5 md:px-10 bg-background transition-colors">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 -top-24 mx-auto h-56 w-[42rem] rounded-[28rem] blur-3xl 
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h2 className="mt-4 text-3xl md:text-5xl font-semibold tracking-tight text-neutral-900 dark:text-white">
          ...
          <div className="lg:ml-auto">
            <div
              className="rounded-2xl border bg-white/80 backdrop-blur shadow-xl 
              ...
              <form onSubmit={handleSubmit} className="p-6 md:p-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="mt-1 w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-neutral-900 placeholder:text-neutral-400
                  ...
                  <div className="sm:col-span-1">
                    ...
                    <select
                      id="projectType"
                      name="projectType"
                      className="mt-1 w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 text-neutral-900
                                 focus:outline-none focus:ring-2 focus:ring-[#c0ff72] focus:border-[#c0ff72]
                                 dark:border-white/10 dark:bg-neutral-900 dark:text-white"
                      defaultValue=""
                    >
                ...
                <div className="mt-4">
                  ...
                  <textarea
                    ...
                    className="mt-1 w-full rounded-xl border border-neutral-300 bg-white px-3 py-3 text-neutral-900 placeholder:text-neutral-400
                               focus:outline-none focus:ring-2 focus:ring-[#c0ff72] focus:border-[#c0ff72]
                               dark:border-white/10 dark:bg-neutral-900 dark:text-white"
                    required
                  />
                ...
                <div className="mt-4 flex items-start gap-3">
                  <input
                    ...
                    name="agree"
                    type="checkbox"
                    className="mt-1 size-4 rounded border-neutral-300 text-neutral-900 
